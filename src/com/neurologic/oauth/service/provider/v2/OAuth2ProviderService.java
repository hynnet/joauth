 ...
 */
package com.neurologic.oauth.service.provider.v2;
 ...
 *
 */
public abstract class OAuth2ProviderService implements OAuthProviderService<OAuth2ServiceProvider> {

	protected final Logger logger = Logger.getLogger(this.getClass());
	private static final String OAUTH_AUTHORIZATION_HEADER_START = "Basic ";
	
	protected OAuth2ServiceProvider serviceProvider;
	
	/* (non-Javadoc)
	 * @see com.neurologic.oauth.service.OAuthProviderService#setOAuthServiceProvider(net.oauth.provider.OAuthServiceProvider)
	 */
	@Override
	public void setOAuthServiceProvider(OAuth2ServiceProvider serviceProvider) {
